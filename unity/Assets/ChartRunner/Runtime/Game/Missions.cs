...
namespace ChartRunner.Game
{
    ...
    public static class Missions
    {
        ...
        {
            new Def { Id = "dist", Txt = v => "Проехать " + v + "m", Gen = r => 300 + r.Next(6) * 100, Val = s => s.Dist, Rew = 40 },
            new Def { Id = "gems", Txt = v => "Собрать $" + v, Gen = r => 15 + r.Next(5) * 5, Val = s => s.Coins, Rew = 35 },
            new Def { Id = "spd", Txt = v => "Разгон до " + v + " км/ч", Gen = r => 150 + r.Next(5) * 20, Val = s => s.Kmh, Rew = 40 },
            new Def { Id = "pos", Txt = v => "Позиция $" + v, Gen = r => 40 + r.Next(5) * 20,
