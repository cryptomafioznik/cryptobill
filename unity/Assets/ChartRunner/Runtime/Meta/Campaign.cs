...
namespace ChartRunner.Meta
{
    ...
    public static class Campaign
    {
        ...
        {
            Tr("c01","btc","BTCUSDT",1567296000000,"Тихий вторник","Тихий","BTC · сен 2019",80,200,450,40),
            Tr("c02","eth","ETHUSDT",1684800000000,"Штиль","Штиль","ETH · май 2023",110,280,600,60),
            Tr("c03","doge","DOGEUSDT",1707350400000,"Прогрев","Прогрев","DOGE · фев 2024",150,360,780,80),
            Tr("c04","btc","BTCUSDT",1640995200000,"Дрейф","Дрейф","BTC · янв 2022",220,540,1150,110),
            Tr("c05","sol","SOLUSDT",1693526400000,"Раскачка","Раскачка","SOL · сен 2023",300,750,1600,140),
            Tr("c06","eth","ETHUSDT",1659312000000,"Сползание","Сполз.","ETH · авг 2022",380,950,2000,170),
            Tr("c07","btc","BTCUSDT",1731628800000,"Ралли","Ралли","BTC · ноя 2024",450,1100,2400,200),
            Tr("c08","sol","SOLUSDT",1636934400000,"Импульс","Импульс","SOL · ноя 2021",540,1350,2900,230),
            Tr("c09","xrp","XRPUSDT",1640131200000,"Боковик","Боковик","XRP · дек 2021",620,1500,3200,260),
            Tr("c10","link","LINKUSDT",1628812800000,"Памп +11%","Памп+11","LINK · авг 2021",720,1800,3800,300),
            Tr("b1","btc","BTCUSDT",1667952000000,"КРАХ FTX","FTX −13%","BTC −13% · 11.2022",800,2000,4300,340,true),
            Tr("c11","bnb","BNBUSDT",1622505600000,"Качели","Качели","BNB · июн 2021",850,2100,4500,360),
            Tr("c12","avax","AVAXUSDT",1637280000000,"Памп +9%","Памп+9","AVAX · ноя 2021",950,2400,5000,400),
            Tr("c13","wif","WIFUSDT",1711238400000,"WIF +15%","WIF+15","WIF · мар 2024",1050,2700,5800,440),
            Tr("c14","eth","ETHUSDT",1620864000000,"Бычий шторм","Шторм","ETH · май 2021",1200,3000,6500,490),
            Tr("b2","btc","BTCUSDT",1722816000000,"АВГУСТ-ОБВАЛ","АВГ −16%","BTC −16% · 08.2024",1300,3300,7000,540,true),
            Tr("c15","doge","DOGEUSDT",1620432000000,"DOGE-безумие","DOGE","DOGE · май 2021",1450,3600,7800,560),
            Tr("b3","btc","BTCUSDT",1583971200000,"BLACK THURSDAY","BLACK −28%","BTC −28% · 03.2020",1600,4000,8800,640,true),
            Tr("c16","pepe","PEPEUSDT",1683849600000,"PEPE: ланч","PEPE+8","PEPE · май 2023",1800,4500,10000,720),
            Tr("c17","bonk","BONKUSDT",1701907200000,"BONK обвал","BONK−19","BONK −19% · 12.2023",2100,5200,11500,850),
        };
        ...
        public static Challenge DailyChallenge(out Tickers.Ticker coin)
        {
            ...
            return new Challenge
            {
                ...
                Name = isBank ? "Заработать на " + coin.Name : "Доехать: " + coin.Name,
