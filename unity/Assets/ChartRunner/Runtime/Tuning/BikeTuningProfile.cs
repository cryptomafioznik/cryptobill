...
namespace ChartRunner.Tuning
{
    ...
    public class BikeTuningProfile : ScriptableObject
    {
        ...
        [Tooltip("ПЛЕЙСХОЛДЕР. Выводится из кривой разгона §7.3, не из RB.engine.")]
        public float engineForceN = 3000f;

        [Tooltip("ПЛЕЙСХОЛДЕР. Выводится из «заезжает на 45° и не буксует» §7.4, не из RB.mu = 2.6.")]
        public float tyreFriction = 1.1f;
        ...
        public float brakeForceN = 1500f;
